...
<title>상세 게시글</title>
<link rel="stylesheet"
	href="${contextPath}/resources/css/boardDatail.css">
...
<body style="overflow-x: hidden">
	...
	<div class="container">
		...
		<div class="content">
			...
			<!-- 게시글 내용 -->
			<div class="datail">롱일랜드 아이스티, 줄여서 '롱티'라고도 자주 불리는 이 칵테일은 달콤한 콜라
			...
			<form>
				...
				<div class="share">
					<button type="button" id="bookBtn">
						<img isd="bookBtnImg" src="../images/bookmark.svg"
							onclick="bookBtnClick()">
					</button>
					<button type="button" id="likeBtn">
						<img src="../images/heart.svg" id="likeBtnImg"
				...
				<div class="commentWrite">
					<input type="text" name="commentWrite" id="commentWrite"
						placeholder="댓글을 입력해주세요.">
					<button type="submit" name="commentbtn" id="commentbtn">댓글
						저장</button>
				</div>
			</form>
			<!-- 댓글 -->
			<div class="comment">
				<div class="profilePicture">
					<img src="${contextPath}/resources/images/person-circle.svg">
				</div>
				<div class="userName">
					user01
					<div class="commentContent">안녕하세요 글이 너무 좋은걸요?</div>
				</div>
			</div>
			<div class="comment">
				<div class="profilePicture">
				...
				<div class="userName">
					user02
					<div class="commentContent">친구해요~~</div>
				</div>
			</div>
