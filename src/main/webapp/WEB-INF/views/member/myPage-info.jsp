                ...
                <fieldset>
                    <table>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <c:if test="${addr[0] == 'NULL'}">
                                    <input type="text" id="sample6_postcode" name="memberAddress" value="" readonly>
                                    <input type="button" id="postBtn" onclick="sample6_execDaumPostcode()" name="btn-fill-s" value="우편번호 찾기"><br>
                                    <input type="text" id="sample6_address" name="memberAddress" value="" readonly><br>
                                    <input type="text" id="sample6_detailAddress" name="memberAddress" value="">
                                    <input type="text" id="sample6_extraAddress" name="memberAddress" value="" readonly>
                                </c:if>
                                <c:if test="${addr[0]!='NULL'}">
