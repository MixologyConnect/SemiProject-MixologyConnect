...
<body class="themes-main-1">
    ...
    <br><br>
    제1조 (목적)<br>
    이 약관은 "Mixology Connect" 인터넷 사이트 (www.mixologyconnection.com, 이하 “믹스올로지 커넥션”이라 함) 통해서 제공하는 전자상거래 관련 서비스 및 기타 온라인 서비스 (이하 “서비스”라 함)를 이용하는 자간의 권리, 의무를 확정하고 이를 이행함으로써 상호 발전을 도모하는 것을 그 목적으로 합니다.
    <br><br>
    제2조(약관의 명시, 효력과 개정)<br>
    1. 회사는 이 약관의 내용을 회원이 확인할 수 있도록 "믹스올로지"초기 서비스화면 또는 연결화면에 게시합니다.
    <br>
    ...
    <br>2, 이 약관 및 서비스 이용과 관련하여 회사와 회원 사이에 분쟁이 발생하여 소송이 제기되는 경우에는 『민사소송법』에 따라 관할법원을 정합니다.
                ...
                <div id="check-area">
                    ...
                    <input type="checkbox" name="checkbox" value="inforYes">
                    <label><span class="blue">(필수)</span>개인정보 수집 및 이용 </label>
