...
<body>
    ...
    <main>
       ...
       <!-- --------------------------------------------------------------------------------------------- --> 
        ...
        <div class="result1">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/갓파더.webp"></div>
                <div>파우스트</div>
        ...
        <div class="result2">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/맨해튼(칵테일).jpg"></div>
                <div>블랙러시안</div>
        ...
        <div class="result3">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/모히토.jpg"></div>
                <div>롱아일랜드 아이스티</div>
        ...
        <div class="result4">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/코스모폴리탄.jpg"></div>
                <div>갓파더</div>
        ...
        <div class="result5">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/예거밤.webp"></div>
                <div>사제락</div>
        ...
        <div class="result6">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/김렛.webp"></div>
                <div>카타르시스</div>
                <div>매혹적인 색깔로 유명한 칵테일, 새콤함에 숨겨진 독한 맛 <br><br>
                    약 20-30도
                </div>
        ...
        <div class="result7">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/다이키리.webp"></div>
                <div>블랙 벨벳</div>
                <div>매혹적인 색깔로 유명한 칵테일, 새콤함에 숨겨진 독한 맛 <br><br>
                    약 20-30도
                </div>
        ...
        <div class="result8">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/말리부 밀크.webp"></div>
                <div>더티호</div>
                <div>매혹적인 색깔로 유명한 칵테일, 새콤함에 숨겨진 독한 맛 <br><br>
                    약 20-30도
                </div>
        ...
        <div class="result9">
            <div class="cocktail">
                <div><img style="width: 300px;" src="${contextPath}/img/아디오스 마더퍼커.webp"></div>
                <div>행맨스 블러드</div>
                <div>매혹적인 색깔로 유명한 칵테일, 새콤함에 숨겨진 독한 맛 <br><br>
                    약 20-30도
                </div>
